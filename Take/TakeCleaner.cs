...
public class TakeCleaner : MonoBehaviour
{
    ...
    public void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, distance) && hit.transform.CompareTag("Button"))
            {
                CollectCleaner(hit.transform.gameObject);
            }
        }
    }

    public void CollectCleaner(GameObject cleaner)
    {
